...
## Introduction to Common Model Selections Critera
...
Given a dataset $y$, models $M_k$, weights $w_{i,k}^s$, and parameters $\theta$, PSIS-LOO is an efficient way to approximate the estimate of the expected log pointwise predictive density for model k, which is the measure of how good model k is at fitting out of sample data:
